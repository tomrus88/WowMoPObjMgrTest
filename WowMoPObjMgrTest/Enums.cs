...
namespace WowMoPObjMgrTest
{
    ...
    enum CGUnitData
    {
        ...
        DynamicFlags = CGObjectData.End + 70, // size 1, flags MIRROR_VIEWER_DEPENDENT
        ModCastingSpeed = CGObjectData.End + 71, // size 1, flags MIRROR_ALL
        ModSpellHaste = CGObjectData.End + 72, // size 1, flags MIRROR_ALL
        ModHaste = CGObjectData.End + 73, // size 1, flags MIRROR_ALL
        ModHasteRegen = CGObjectData.End + 74, // size 1, flags MIRROR_ALL
        CreatedBySpell = CGObjectData.End + 75, // size 1, flags MIRROR_ALL
        NpcFlags = CGObjectData.End + 76, // size 2, flags MIRROR_ALL, MIRROR_VIEWER_DEPENDENT
        EmoteState = CGObjectData.End + 78, // size 1, flags MIRROR_ALL
        Stats = CGObjectData.End + 79, // size 5, flags MIRROR_SELF, MIRROR_OWNER
        StatPosBuff = CGObjectData.End + 84, // size 5, flags MIRROR_SELF, MIRROR_OWNER
        StatNegBuff = CGObjectData.End + 89, // size 5, flags MIRROR_SELF, MIRROR_OWNER
        Resistances = CGObjectData.End + 94, // size 7, flags MIRROR_SELF, MIRROR_OWNER, MIRROR_EMPATH
        ResistanceBuffModsPositive = CGObjectData.End + 101, // size 7, flags MIRROR_SELF, MIRROR_OWNER
        ResistanceBuffModsNegative = CGObjectData.End + 108, // size 7, flags MIRROR_SELF, MIRROR_OWNER
        BaseMana = CGObjectData.End + 115, // size 1, flags MIRROR_ALL
        BaseHealth = CGObjectData.End + 116, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        ShapeshiftForm = CGObjectData.End + 117, // size 1, flags MIRROR_ALL
        AttackPower = CGObjectData.End + 118, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        AttackPowerModPos = CGObjectData.End + 119, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        AttackPowerModNeg = CGObjectData.End + 120, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        AttackPowerMultiplier = CGObjectData.End + 121, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        RangedAttackPower = CGObjectData.End + 122, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        RangedAttackPowerModPos = CGObjectData.End + 123, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        RangedAttackPowerModNeg = CGObjectData.End + 124, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        RangedAttackPowerMultiplier = CGObjectData.End + 125, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        MinRangedDamage = CGObjectData.End + 126, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        MaxRangedDamage = CGObjectData.End + 127, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        PowerCostModifier = CGObjectData.End + 128, // size 7, flags MIRROR_SELF, MIRROR_OWNER
        PowerCostMultiplier = CGObjectData.End + 135, // size 7, flags MIRROR_SELF, MIRROR_OWNER
        MaxHealthModifier = CGObjectData.End + 142, // size 1, flags MIRROR_SELF, MIRROR_OWNER
        HoverHeight = CGObjectData.End + 143, // size 1, flags MIRROR_ALL
        MinItemLevel = CGObjectData.End + 144, // size 1, flags MIRROR_ALL
        MaxItemLevel = CGObjectData.End + 145, // size 1, flags MIRROR_ALL
        WildBattlePetLevel = CGObjectData.End + 146, // size 1, flags MIRROR_ALL
        BattlePetCompanionNameTimestamp = CGObjectData.End + 147, // size 1, flags MIRROR_ALL
        End = CGObjectData.End + 148
    }
